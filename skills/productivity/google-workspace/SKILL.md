...
- `references/google_cleanup.md` — Session-specific cleanup & revoke steps (local paths, crontab, revoke guidance)
- `references/service_account_dwd.md` — Service Account + Domain‑wide delegation summary, scopes, and impersonation example
